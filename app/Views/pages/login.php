            ...
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-6 p-2 d-flex align-items-center">
                        <img src="assets/images/flat.png" alt="login" class="flex align-items-center" width="100%">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            <div class="brand-wrapper" style="font-size: 20px;">
                                <i class="fas fa-user-graduate"></i>
                                <span style="font-weight: bold;">Beasiswa Stimulan Kerjasama</span>
                            </div>
